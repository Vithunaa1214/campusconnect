...
class _ProfShellState extends State<ProfShell> with TickerProviderStateMixin {
  int _currentIndex = 0;
  int _attendanceBadgeCount = 3; // Simulate pending attendance actions
            ...
            Expanded(
              child: IndexedStack(
                ...
                children: [
                  ...
                  _buildNavigator(3, const TimetablePage()),
                  _buildNavigator(4, const SeatingPage()),
                  _buildNavigator(5, const ProfilePage()),
                ],
              ),
            ),
          ],
        ...
        child: NavigationBar(
          ...
          destinations: [
            ...
            const NavigationDestination(
              ...
              selectedIcon: Icon(Icons.event_seat),
              label: 'Seating',
              tooltip: 'Exam seating arrangements',
            ),
            const NavigationDestination(
              icon: Icon(Icons.person_outline),
              selectedIcon: Icon(Icons.person),
